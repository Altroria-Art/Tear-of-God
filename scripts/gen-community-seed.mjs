...
const TEMPLATES = [
  { id: 'tmpl_001', hashtags: '#Anime,#Tierlist', title: 'Top Shonen Anime', tiers: STD_TIERS,
  ...
  { id: 'tmpl_002', hashtags: '#Anime,#Movie', title: 'Ghibli Movies', tiers: STD_TIERS,
  ...
  { id: 'tmpl_003', hashtags: '#Anime,#Retro', title: '2000s Anime', tiers: STD_TIERS,
  ...
  { id: 'tmpl_004', hashtags: '#Anime,#Isekai', title: 'Isekai ยอดนิยม', tiers: STD_TIERS,
  ...
  { id: 'tmpl_009', hashtags: '#Gaming,#Nintendo', title: 'Switch Games', tiers: STD_TIERS,
  ...
  { id: 'tmpl_010', hashtags: '#Gaming,#RPG', title: 'สุดยอดเกม RPG ในตำนาน', tiers: STD_TIERS,
  ...
  { id: 'tmpl_017', hashtags: '#Anime,#2026', title: 'อนิเมะในดวงใจ ปี 2026', tiers: STD_TIERS,
  ...
  { id: 'tmpl_018', hashtags: '#Gaming,#OpenWorld', title: 'Open-World RPG ยอดนิยม', tiers: STD_TIERS,
  ...
  { id: 'tmpl_019', hashtags: '#Tech,#Programming', title: 'ภาษาโปรแกรมสาย Dev', tiers: STD_TIERS,
    items: ['TypeScript', 'Python', 'Rust', 'PHP', 'JavaScript', 'Go', 'Java', 'C++', 'Kotlin', 'Swift'] },
  { id: 'tmpl_020', hashtags: '#Movie,#MindBender', title: 'หนังไซไฟสายสมองแตก', tiers: STD_TIERS,
  ...
  { id: 'tmpl_021', hashtags: '#Series,#Netflix', title: 'Netflix Originals ยอดฮิต', tiers: STD_TIERS,
    items: ['Stranger Things', 'Wednesday', 'The Witcher', 'Money Heist', 'Squid Game', 'Dark', 'Ozark', 'The Crown', 'Bridgerton'] },
  { id: 'tmpl_022', hashtags: '#Series,#KDrama', title: 'K-Drama ในดวงใจ', tiers: STD_TIERS,
  ...
  { id: 'tmpl_023', hashtags: '#Series,#ThaiSeries', title: 'ซีรีส์ไทยยอดนิยม', tiers: STD_TIERS,
  ...
  { id: 'tmpl_024', hashtags: '#Sports,#PremierLeague', title: 'นักเตะพรีเมียร์ลีกที่เก่งที่สุด', tiers: STD_TIERS,
  ...
  { id: 'tmpl_025', hashtags: '#Sports,#ThaiFootball', title: 'นักฟุตบอลไทยในดวงใจ', tiers: STD_TIERS,
  ...
  { id: 'tmpl_026', hashtags: '#Book,#Fantasy', title: 'นิยายแฟนตาซีที่ต้องอ่าน', tiers: STD_TIERS,
  ...
  { id: 'tmpl_027', hashtags: '#Book,#SelfHelp', title: 'หนังสือ Self-Help เปลี่ยนชีวิต', tiers: STD_TIERS,
  ...
  { id: 'tmpl_028', hashtags: '#Tech,#Smartphone', title: 'แบรนด์สมาร์ทโฟนยอดนิยม', tiers: STD_TIERS,
    items: ['iPhone', 'Samsung Galaxy', 'Google Pixel', 'Xiaomi', 'OnePlus', 'OPPO', 'vivo', 'ASUS ROG Phone'] },
  { id: 'tmpl_029', hashtags: '#Anime,#SportsAnime', title: 'อนิเมะกีฬาที่มันส์ที่สุด', tiers: STD_TIERS,
    items: ['Haikyuu!!', 'Blue Lock', 'Slam Dunk', "Kuroko's Basketball", 'Hajime no Ippo', 'Captain Tsubasa', 'Ace of Diamond', 'Free!'] },
  { id: 'tmpl_030', hashtags: '#Gaming,#Esports', title: 'เกม Esport ยอดนิยม', tiers: STD_TIERS,
    items: ['League of Legends', 'Valorant', 'Counter-Strike 2', 'Dota 2', 'Overwatch 2', 'RoV', 'Mobile Legends', 'Apex Legends'] },
  { id: 'tmpl_031', hashtags: '#Food,#Dessert', title: 'ของหวานไทยที่ต้องลอง', tiers: STD_TIERS,
    items: ['ทับทิมกรอบ', 'ข้าวเหนียวมะม่วง', 'ลอดช่องสิงคโปร์', 'บัวลอย', 'ขนมชั้น', 'ฝอยทอง', 'ทองหยิบ', 'สังขยาฟักทอง'] },
  { id: 'tmpl_032', hashtags: '#Music,#Pop', title: 'เพลงป็อปสากลมาแรง', tiers: STD_TIERS,
  ...
  { id: 'tmpl_033', hashtags: '#Anime,#Fantasy,#Isekai', title: 'อนิเมะแฟนตาซีสุดมันส์', tiers: STD_TIERS,
  ...
  { id: 'tmpl_034', hashtags: '#Anime,#Retro,#Tierlist', title: 'อนิเมะยุค 90 ในตำนาน', tiers: STD_TIERS,
    items: ['Neon Genesis Evangelion', 'Dragon Ball Z', 'Sailor Moon', 'Rurouni Kenshin', 'Yu Yu Hakusho', 'Slam Dunk', 'Ranma 1/2', 'Berserk'] },
  { id: 'tmpl_035', hashtags: '#Anime,#SportsAnime', title: 'อนิเมะกีฬาที่ถูกมองข้าม', tiers: STD_TIERS,
  ...
  { id: 'tmpl_036', hashtags: '#Anime,#Thriller,#SciFi', title: 'อนิเมะจิตวิทยาเข้มข้น', tiers: STD_TIERS,
    items: ['Death Note', 'Monster', 'Paranoia Agent', 'Serial Experiments Lain', 'Perfect Blue', 'Steins;Gate', 'Erased', 'Psycho-Pass'] },
  { id: 'tmpl_037', hashtags: '#Anime,#Gaming,#RPG', title: 'อนิเมะที่ดัดแปลงจากเกม', tiers: STD_TIERS,
    items: ['Sword Art Online', 'Overlord', 'Log Horizon', 'No Game No Life', 'Btooom!', 'High Score Girl', 'Konosuba', '.hack//Sign'] },

  { id: 'tmpl_038', hashtags: '#Gaming,#RPG,#OpenWorld', title: 'เกม RPG แนวตะวันตกสุดยิ่งใหญ่', tiers: STD_TIERS,
  ...
  { id: 'tmpl_039', hashtags: '#Gaming,#Mobile,#RPG', title: 'เกมมือถือแนว RPG ยอดฮิต', tiers: STD_TIERS,
  ...
  { id: 'tmpl_040', hashtags: '#Gaming,#Nintendo,#Retro', title: 'เกม Nintendo คลาสสิกในตำนาน', tiers: STD_TIERS,
  ...
  { id: 'tmpl_041', hashtags: '#Gaming,#Esports', title: 'เกม Esport ที่มีคนดูมากที่สุด', tiers: STD_TIERS,
    items: ['League of Legends', 'Dota 2', 'Counter-Strike 2', 'Valorant', 'PUBG: Battlegrounds', 'Fortnite', 'Rainbow Six Siege', 'StarCraft II'] },
  { id: 'tmpl_042', hashtags: '#Gaming,#Souls,#OpenWorld', title: 'เกม Soulslike จากสตูดิโอญี่ปุ่น', tiers: STD_TIERS,
    items: ['Elden Ring', 'Sekiro', 'Dark Souls', 'Bloodborne', "Demon's Souls", 'Nioh', 'Wo Long: Fallen Dynasty', 'Code Vein'] },

  { id: 'tmpl_043', hashtags: '#Movie,#Superhero', title: 'หนังแอ็คชั่นฟอร์มยักษ์', tiers: STD_TIERS,
  ...
  { id: 'tmpl_044', hashtags: '#Movie,#Crime,#Thriller', title: 'หนังอาชญากรรมสุดเข้มข้น', tiers: STD_TIERS,
    items: ['The Godfather', 'Se7en', 'No Country for Old Men', 'The Departed', 'Prisoners', 'Zodiac', 'Gone Girl', 'Nightcrawler'] },
  { id: 'tmpl_045', hashtags: '#Movie,#SciFi,#MindBender', title: 'หนังไซไฟฟอร์มยักษ์', tiers: STD_TIERS,
    items: ['Dune', 'Interstellar', 'Arrival', 'Blade Runner 2049', 'Edge of Tomorrow', 'The Prestige', 'Looper', 'Ex Machina'] },
  { id: 'tmpl_046', hashtags: '#Movie,#Superhero', title: 'หนังซูเปอร์ฮีโร่ที่ทำเงินสูงสุด', tiers: STD_TIERS,
  ...
  { id: 'tmpl_047', hashtags: '#Series,#Crime,#Netflix', title: 'ซีรีส์อาชญากรรมสืบสวน', tiers: STD_TIERS,
    items: ['Mindhunter', 'True Detective', 'Breaking Bad', 'Better Call Saul', 'Sherlock', 'Narcos', 'Ozark', 'You'] },
  { id: 'tmpl_048', hashtags: '#Series,#Fantasy,#Netflix', title: 'ซีรีส์แฟนตาซีระดับตำนาน', tiers: STD_TIERS,
  ...
  { id: 'tmpl_049', hashtags: '#Series,#KDrama', title: 'ซีรีส์เกาหลีแนวโรแมนติก', tiers: STD_TIERS,
  ...
  { id: 'tmpl_050', hashtags: '#Series,#ThaiSeries,#Netflix', title: 'ซีรีส์ไทยแนวดราม่าเข้มข้น', tiers: STD_TIERS,
    items: ['มณีนาคา', 'บุพเพสันนิวาส', 'เพลิงพระนาง', 'กรงกรรม', 'มนต์รักหนองผักกะแยง', 'เลือดข้นคนจาง', 'ปมรัก', 'ทองเอก หมอยาท่าโฉลง'] },

  { id: 'tmpl_051', hashtags: '#Food,#Dessert', title: 'ของหวานนานาชาติที่ต้องลอง', tiers: STD_TIERS,
    items: ['Tiramisu', 'Macaron', 'Creme Brulee', 'Mochi', 'Baklava', 'Churros', 'Gelato', 'Pavlova'] },
  { id: 'tmpl_052', hashtags: '#Food,#StreetFood,#Thai', title: 'สตรีทฟู้ดเอเชียยอดนิยม', tiers: STD_TIERS,
    items: ['ผัดไทย', 'Pad Kra Pao', 'ส้มตำ', 'Satay', 'Banh Mi', 'Takoyaki', 'Tteokbokki', 'Char Kway Teow'] },
  { id: 'tmpl_053', hashtags: '#Food,#Thai', title: 'เมนูอาหารไทยประจำภาค', tiers: STD_TIERS,
    items: ['แกงเขียวหวาน', 'ต้มยำกุ้ง', 'แกงมัสมั่น', 'ลาบหมู', 'น้ำพริกหนุ่ม', 'ขนมจีนน้ำยา', 'แกงส้ม', 'หมูกระทะ'] },

  { id: 'tmpl_054', hashtags: '#Music,#Pop', title: 'เพลงป๊อปเกาหลี K-Pop มาแรง', tiers: STD_TIERS,
    items: ['BTS', 'BLACKPINK', 'NewJeans', 'Stray Kids', 'TWICE', 'SEVENTEEN', 'aespa', 'IVE'] },
  { id: 'tmpl_055', hashtags: '#Music,#RockThai,#Retro', title: 'เพลงไทยสตริงยุค 2000s', tiers: STD_TIERS,
    items: ['Bodyslam', 'Palmy', 'Getsunova', 'Da Endorphine', 'Slot Machine', 'Portrait', 'Big Ass', 'Scrubb'] },
  { id: 'tmpl_056', hashtags: '#Music,#TPop', title: 'ศิลปิน T-Pop หน้าใหม่มาแรง', tiers: STD_TIERS,
    items: ['4EVE', 'PiXXiE', "BUS'YA", 'Three Man Down', 'Musketeers', 'Getsunova', 'F.HERO', 'Milli'] },

  { id: 'tmpl_057', hashtags: '#Sports', title: 'นักบาสเกตบอล NBA ที่เก่งที่สุด', tiers: STD_TIERS,
  ...
  { id: 'tmpl_058', hashtags: '#Sports,#PremierLeague', title: 'นักเตะตำนานพรีเมียร์ลีก', tiers: STD_TIERS,
    items: ['Thierry Henry', 'Steven Gerrard', 'Ryan Giggs', 'Frank Lampard', 'Wayne Rooney', 'Didier Drogba', 'Alan Shearer', 'Eric Cantona'] },

  { id: 'tmpl_059', hashtags: '#Book,#Crime', title: 'นิยายสืบสวนสอบสวนคลาสสิก', tiers: STD_TIERS,
  ...
  { id: 'tmpl_060', hashtags: '#Book,#SelfHelp', title: 'หนังสือพัฒนาตัวเองขายดี', tiers: STD_TIERS,
  ...
  { id: 'tmpl_061', hashtags: '#Tech,#Smartphone,#2026', title: 'แอปที่ต้องมีในมือถือปี 2026', tiers: STD_TIERS,
    items: ['ChatGPT', 'TikTok', 'Instagram', 'Spotify', 'Notion', 'Canva', 'CapCut', 'Threads'] },
  { id: 'tmpl_062', hashtags: '#Tech,#Programming', title: 'ภาษาโปรแกรมสำหรับ AI/Data', tiers: STD_TIERS,
  ...
  { id: 'tmpl_063', hashtags: '#Movie,#Thriller,#MindBender', title: 'หนังทริลเลอร์จิตวิทยา', tiers: STD_TIERS,
    items: ['Shutter Island', 'Black Swan', 'Memento', 'Fight Club', 'American Psycho', 'The Silence of the Lambs', 'Gone Girl', 'Zodiac'] },
  { id: 'tmpl_064', hashtags: '#Sports,#ThaiFootball', title: 'สโมสรฟุตบอลไทยยอดนิยม', tiers: STD_TIERS,
...
TEMPLATES.forEach((tmpl, tIdx) => {
  ...
  for (let seq = 1; seq <= count; seq++) {
    ...
    rankingRows.push(
      `('${rankingId}', '${esc(tmpl.title)}', '', '${tmpl.hashtags}', '${userId}', '${tmpl.id}', '${createdAt}')`
    );
...
lines.push(chunkedInsert(
  'INSERT OR IGNORE INTO rankings (id, title, description, hashtags, user_id, template_id, created_at) VALUES',
  rankingRows
));
lines.push('');
